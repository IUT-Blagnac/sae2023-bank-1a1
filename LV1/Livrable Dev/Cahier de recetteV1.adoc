...
5+|
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|1 ^|Cliquer sur le bouton "Cloturer". ^|La fenêtre de création des clients s'ouvre. ^| aucune ^|OK
^|2 ^|Compléter les champs spécifiés et valider. ^|Un nouveau compte est créé. ^|aucune ^|OK
