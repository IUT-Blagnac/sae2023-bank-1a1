...
^|ID ^|Action ^|Comportement attendu ^|Pré-conditions ^|Résultat
^|Gestion_T_CC_Cree.1  ^|Cliquer sur le bouton "Cloturer". ^|Affichage d'une fenetre pour définir le solde et le découvert autorisé . ^| Le compte client n'est pas desactivé
 ^|OK
